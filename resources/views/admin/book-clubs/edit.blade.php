                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" 
                                          id="description" 
                                          rows="5"
                                          class="w-full rounded-lg border-stone-700 bg-stone-950 text-stone-100 placeholder-stone-500 focus:border-amber-500 focus:ring-amber-500">{{ old('description', $bookClub->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            @if($bookClub->image)
                                <div class="md:col-span-2">
                                    ...
                                    <img src="{{ Storage::url($bookClub->image) }}" 
                                         alt="{{ $bookClub->name }}"
                                         class="w-32 h-32 object-cover rounded border border-stone-700">
                                </div>
                            @endif
