        ...
        <div class="flex justify-between h-16">
            ...
            @else
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                    ...
                    <a href="{{ route('register') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-lg font-semibold text-sm text-white hover:bg-indigo-700 transition ease-in-out duration-150">
                        Get Started
                    </a>
                </div>
            @endauth
